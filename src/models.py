...
from src.aggregators import MeanAggregator

flags = tf.app.flags
FLAGS = flags.FLAGS

# LayerInfo is a namedtuple that specifies the parameters 
# of the recursive GraphHAT layers
...
class SampleAndAggregate(GeneralizedModel):
    """
    Base implementation of unsupervised GraphHAT
    """
    ...
    def __init__(self, placeholders, features, adj, degrees,
        ...
        Args:
            ...
            - layer_infos: List of LayerInfo namedtuples that describe the parameters of all 
                   the recursive layers. See LayerInfo definition above.
    ...
    def _build(self):
        ...
        self.link_pred_layer = layers.BipartiteEdgePredLayer(dim_mult*self.dims[-1],
...
class GraphHAT(SampleAndAggregate):
    """Implementation of supervised GraphHAT."""

    def __init__(self, num_classes,
            placeholders, features, adj, degrees,
            layer_infos, concat=True, aggregator_type="mean", 
            sigmoid_loss=False, identity_dim=0,
                **kwargs):
        '''
        Args:
            - placeholders: Stanford TensorFlow placeholder object.
